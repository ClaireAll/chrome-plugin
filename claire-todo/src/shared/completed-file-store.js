...
// 追加完成记录，兼容旧的文本参数和新的记录对象。
export async function appendCompletedRecordToFile(recordOrText, completedAt, durationMs) {
  return mutateCompletedData((data) => appendCompletedRecord(data, recordOrText, completedAt, durationMs));
}
